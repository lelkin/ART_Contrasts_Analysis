...
# Intro
If you've come here after reading our paper because you're curious about how we did our analysis and made our visualizations, welcome! If not, you can find the paper here for some more technical details (INSERT PAPER LINK).
...
The code we used to calculate observed Type I error and observed statistical power for our raw logs can be found here (INSERT LINK), but it's not the nicest code I've ever written, and we really did just count how many times we saw *p < .05* and how many tests we did and divide.
